...
def build_fresh_generation_prompt(
    ...
    parts.append(
        ...
        "RULES:\n"
        "1. Generate hypotheses from every Active theory. Each Active theory should produce "
        "at least one hypothesis. There is no cap -- generate as many as the theory and data support.\n"
        ...
        "3. You may generate hypotheses from the Adjacent wildcard theory (if provided).\n"
