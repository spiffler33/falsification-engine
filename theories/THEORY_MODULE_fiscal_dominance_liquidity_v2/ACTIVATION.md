...
| Deficit pace | US Treasury monthly budget statements | `web-search` · Preferred source: US Treasury Monthly Treasury Statement, CBO Monthly Budget Review | Above $1.5T annualized | above | 0.20 | The fuel. Below $1.5T, the fiscal impulse is insufficient to overpower QT at current balance sheet runoff rates (~$60B/month ≈ ~$720B/year). The $1.5T threshold is calibrated to the approximate equilibrium point where fiscal injection ≈ QT extraction at 2024–2025 QT pace. Recalibrate if QT pace changes materially. |
